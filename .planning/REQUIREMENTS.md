...
- [ ] **BENCH-01**: A build of core_nt (or a ≥100 GB representative subset) is run with the new implementation, recording per-stage wall-clock time: offset pre-pass, k-mer extraction, sort, filter, write per flush cycle
